  ...
  fields: [
    ...
    },
    {
      ...
      columns: [
        ...
        {
          id: 'col_part_drawing_no',
          type: 'text',
          label: '物料图号',
          name: 'part_drawing_no',
          required: true,
          placeholder: '如 26136411',
        },
        {
          id: 'col_part_name',
          type: 'text',
          ...
          name: 'part_name',
          required: true,
          placeholder: '如 方向盘开关总成',
        },
        {
          id: 'col_material_quantity',
          type: 'number',
          label: '物料数量',
