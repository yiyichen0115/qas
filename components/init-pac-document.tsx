  ...
  fields: [
    ...
    },
    {
      ...
      linkage: {
        ...
        sourceType: 'vin',
        targetMappings: [
          { targetField: 'platformCode', sourceProperty: 'platformCode' },
          { targetField: 'platformName', sourceProperty: 'platformName' },
          { targetField: 'production_date', sourceProperty: 'productionDate' },
          { targetField: 'configName', sourceProperty: 'configName' },
          { targetField: 'mileage', sourceProperty: 'mileage' },
        ],
      },
    },
    {
